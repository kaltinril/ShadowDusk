...
(pow-square), and **Rule 11** (reciprocal fold), applied before `posFixup` injection.
...
stage, so skipping 9a loses no issue-#136 coverage. Rules 5/6/6b/12 (fragment outputs,
