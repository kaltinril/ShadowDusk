...
```bash
dotnet test --configuration Release --filter "Category!=Integration" --logger "console;verbosity=normal"
```
...
```bash
dotnet test --configuration Release --filter "Category=Integration&Platform=OpenGL"
dotnet test --configuration Release --filter "Category=Integration&Platform=DirectX"
dotnet test --configuration Release --filter "Category=Integration&Platform=Metal"
```
