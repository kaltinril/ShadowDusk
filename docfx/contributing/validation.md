...
- **Seven in-process OpenGL render gates run in CI** on Mesa llvmpipe (`.github/workflows/validation-render.yml`): `StateFidelity`, `CbufferModel`, `TextureBreadthValidation`, `ReservedWordGl`, `SamplerPairsGl`, `DeferredSpriteMrtGl`, and `ShaderToyRouteGl`.
