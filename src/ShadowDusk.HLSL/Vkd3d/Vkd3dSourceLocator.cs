...
internal static partial class Vkd3dSourceLocator
{
    ...
    /// expression, struct body, parameter list, initializer) — measured on vkd3d 1.17. Bison
    ...
    /// <summary>
    /// The diagnostic text vkd3d 1.17 emits for the sentinel (code E5000) when its parser was
