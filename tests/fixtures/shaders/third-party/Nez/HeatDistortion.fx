...
//   Upstream   : DefaultContentSource/effects/HeatDistortion.fx
//   License    : MIT - Copyright (c) 2016 Mike (see ./LICENSE, ./NOTICE.md)
//   Exercises  : UV distortion via a 2nd sampler with explicit AddressU/V=Wrap sampler_state; time-scrolled UV.
// =============================================================================
sampler s0;
