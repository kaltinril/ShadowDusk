...
//   Commit     : d507a73487335b6afceec4b2f518d167df28544a
//   Upstream   : Source/Content/apos-shapes.fx
//   License    : MIT - Copyright (c) 2021 Jean-David Moisan (see ./LICENSE, ./NOTICE.md)
//   Exercises  : The derivative-based-antialiasing revision of Gum's SDF shape
//                renderer (issue #136): ddx/ddy of the SDF value and of an
//                interpolated world position feed the AA footprint, alongside
//                conditional discard, an inlined-helper early return (SPIRV-
//                Cross's one-shot do-while), and genuine Newton-iteration
//                loops. Pins that NO gradient op lands inside a loop with a
//                divergent exit in the emitted GLSL (ANGLE D3D11 zeroes
//                derivatives there - the issue-#136 poisoning).
// =============================================================================
#if __KNIFX__
