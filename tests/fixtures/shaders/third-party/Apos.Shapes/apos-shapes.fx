...
//   Commit     : 3fb73b8d0a51f86678269a4ad28391459cc771b1
//   Upstream   : Source/Content/apos-shapes.fx
//   License    : MIT - Copyright (c) 2021 Jean-David Moisan (see ./LICENSE, ./NOTICE.md)
//   Exercises  : Gum's SDF shape renderer. One large VS+PS effect: 10 TEXCOORD
//                interpolants, __KNIFX__/OPENGL macro profile branch, a Newton-
//                iteration for-loop (EllipseSDF), int locals, chained if/else
//                shape dispatch, % modulo, ternaries, discard, tex2D, two
//                samplers (one register(s0)), Oklab color + gradient math.
// =============================================================================
#if __KNIFX__
