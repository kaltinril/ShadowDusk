...
//   Upstream   : Samples/KniGumInCode/KniGumInCodeContent/Shader.fx
//   License    : MIT - Copyright (c) 2013-2024 FlatRedBall, LLC (see ./LICENSE, ./NOTICE.md)
//   Exercises  : Gum blend-mode effect, explicit-technique form with LOWERCASE
//                'technique/pass/vertexshader = compile vs_2_0 / pixelshader'
//                keywords; legacy 'uniform extern texture', sampler_state blocks,
//                : VIEWPROJ matrix semantic, : COLOR PS outputs, many techniques.
// =============================================================================
