...
//   Upstream   : Samples/FnaGum/FnaSample/Content/Shader.fx
//   License    : MIT - Copyright (c) 2013-2024 FlatRedBall, LLC (see ./LICENSE, ./NOTICE.md)
//   Exercises  : FlatRedBall/Gum blend-mode effect. The TECHNIQUE()/SAMPLE()
//                #define macro idiom (technique defined inside a macro), legacy
//                'uniform extern texture', sampler_state { Texture = <...> },
//                : VIEWPROJ matrix semantic, : COLOR PS outputs, vs_1_1/ps_2_0,
//                premultiply-alpha + linearize helpers, many blend-mode passes.
// =============================================================================
