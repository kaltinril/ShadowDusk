...
//   Tag        : v3.8.5
//   Upstream   : Tests/Assets/Effects/Instancing.fx
//   License    : Ms-PL - Copyright (C) MonoGame Foundation, Inc (see ./LICENSE, ./NOTICE.md)
//   Exercises  : VS-driven + INSTANCED: a float4x4 vertex input on BLENDWEIGHT (4 consecutive input locations) and View/Projection matrices.
// =============================================================================
