...
//   Tag        : v3.8.5
//   Upstream   : Tests/Assets/Effects/ParameterTypes.fx
//   License    : Ms-PL - Copyright (C) MonoGame Foundation, Inc (see ./LICENSE, ./NOTICE.md)
//   Exercises  : The parameter-space sweep: scalars/vectors/matrices/arrays/structs across every EffectParameter class and type.
// =============================================================================
#include "Include.fxh"
