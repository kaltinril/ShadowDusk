...
//   Tag        : v3.8.5
//   Upstream   : Tests/Assets/Effects/ParserTest.fx
//   License    : Ms-PL - Copyright (C) MonoGame Foundation, Inc (see ./LICENSE, ./NOTICE.md)
//   Exercises  : The reference compiler's own FX parser torture test: sampler_state blocks, hex BorderColor, mixed-case render states, multiple passes.
// =============================================================================
