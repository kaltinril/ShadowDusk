// =============================================================================
// apos-shapes.fx  (GitHub issue #202 reproduction copy)
// -----------------------------------------------------------------------------
...
//   Commit     : 3517579be3d087d189db3dff81b4cc109262324e (2026-08-02)
//   Upstream   : Source/Content/apos-shapes.fx
//   License    : MIT - Copyright (c) 2021 Jean-David Moisan (see ./LICENSE, ./NOTICE.md)
//   Exercises  : the exact file behind issue #202: an FNA-target vkd3d diagnostic
//                whose line number lay 581 lines past the construct (dozens of
//                atan2/sincos/smoothstep/asin calls ahead of an int-typed ternary).
//                Lives OUTSIDE tests/fixtures/shaders on purpose: it is a diagnostic
//                location fixture, not a corpus member, so the GL/DX/Vulkan corpus
//                sweeps must not enumerate it.
// =============================================================================
#if __KNIFX__
