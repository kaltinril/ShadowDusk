...
- **ShadowDusk version:** 0.14.1.0 (DX target = vkd3d-shader default, GL target = DXC -> SPIRV-Cross).
...
| examples/Sd0402UniformBoundedLoop.fx | DirectX_11 | PASS |  |  |
| examples/Sd0402UniformBoundedLoop.fx | OpenGL | PASS |  |  |
