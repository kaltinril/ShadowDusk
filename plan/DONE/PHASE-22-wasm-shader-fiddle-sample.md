...
- [x] ✅ Run untrusted-input cases past [Phase 25](PHASE-25-security-hardening.md) — closed 2026-06-15: untrusted third-party `.fx` is the consumer's isolation responsibility (trust model), not a Phase 22 item.
