...
feature. It feeds [Phase 30](PHASE-30-cross-platform-ci.md), which **runs** the resulting
...
- **Cross-platform *runs*** of the suite on Linux/macOS — owned by
  [Phase 30](PHASE-30-cross-platform-ci.md) (Phase 15 §9 / the old "Phase 10 CI"
...
of the whole suite is handed to [Phase 30](PHASE-30-cross-platform-ci.md).
