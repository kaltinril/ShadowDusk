...
- **Backend breadth (post-1.0, validation-gated):** [31](PHASE-31-metal-msl-backend.md) Metal/MSL · [32](PHASE-32-vulkan-backend.md) Vulkan (parked) · [39](DONE/PHASE-39-fna-fx2-output-target.md) ✅ FNA fx_2_0 (all four rungs proven, PS-only + VS-driven — real FNA renders pixel-identical to fxc; vkd3d natives for all four RIDs ship since Phase 37 C) · [4.1](PHASE-4.1-SPIKE-wasm-directx-dxbc.md) DirectX-DXBC-in-WASM spike (parked) — each blocked on a real runtime to render-validate against.
