...
- **Fidelity / completeness:** [28](DONE/PHASE-28-vs-driven-monogame-effects.md) ✅ VS-driven effects — compile the common custom-vertex-shader case, not just PS-only · [33](DONE/PHASE-33-webgl2-es300-hidef-output.md) ✅ KNI HiDef/WebGL2 — close the `gl_FragColor` fidelity gap so one `.mgfx` works in KNI Reach *and* HiDef · [34](DONE/PHASE-34-gl-texture-breadth.md) ✅ GL texture breadth — cube maps everywhere; 3D/LOD on Desktop+HiDef (WebGL1 can't, by platform limit).
