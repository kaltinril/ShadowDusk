...
- **Backend breadth (post-1.0, validation-gated):** [31](PHASE-31-metal-msl-backend.md) Metal/MSL · [32](PHASE-32-vulkan-backend.md) Vulkan (parked) · [39](PHASE-39-fna-fx2-output-target.md) FNA fx_2_0 (rung 2 done; rung 3/4 = MojoShader + real-FNA validation) · [4.1](PHASE-4.1-SPIKE-wasm-directx-dxbc.md) DirectX-DXBC-in-WASM spike (parked) — each blocked on a real runtime to render-validate against.
